...
public class BeamToOrb : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        ((Synchronism)Blackboard.Global[Literals.Strings.Blackboard.Synchronisation.Synchroniser].Value).synchronisers[ListenTo].RegisterCallback(this, SetColours);
    }
    ...
    void Update()
    {
        ...
        currentHSV = Vector3.Lerp(startHSV, endHSV, ((Synchronism)Blackboard.Global[Literals.Strings.Blackboard.Synchronisation.Synchroniser].Value).synchronisers[ListenTo].Percent);
