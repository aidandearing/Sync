...
public class NeutralEmissives : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        ((Synchronism)Blackboard.Global[Literals.Strings.Blackboard.Synchroniser].Value).synchronisers[ListenTo].RegisterCallback(this, colours.SetColour);
    }
    ...
    void Update()
    {
        ...
        colour = colours.Evaluate(((Synchronism)Blackboard.Global[Literals.Strings.Blackboard.Synchroniser].Value).synchronisers[Synchronism.Synchronisations.WHOLE_NOTE].Percent);
